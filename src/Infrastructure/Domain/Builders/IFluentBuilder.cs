...
{
    IFluentBuilder<TEntity, TProperty, TProperty> Include<TProperty>(
        Expression<Func<TEntity, TProperty?>> navigationProperty)
        where TProperty : class, IEntity;

    IFluentBuilder<TEntity, IEnumerable<TProperty>, TProperty> Include<TProperty>(
...
public interface IFluentBuilder<TEntity, TProperty, TGeneric> : IFluentBuilder<TEntity>
    where TEntity : class, IEntity
{
    IFluentBuilder<TEntity, TNextProperty, TNextProperty> ThenInclude<TNextProperty>(
        Expression<Func<TGeneric, TNextProperty?>> navigationProperty) where TNextProperty : class, IEntity;

    IFluentBuilder<TEntity, IEnumerable<TNextProperty>, TNextProperty> ThenInclude<TNextProperty>(
